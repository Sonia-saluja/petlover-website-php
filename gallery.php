...
?>
    ...
    <section class="ftco-section">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="work mb-4 img d-flex align-items-end" style="background-image: url(images/blue-macaw-bird.jpeg);">
            	<a href="images/blue-macaw-bird.jpeg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4">
	              <div class="text w-100 mb-3">
	              	<span>Bird</span>
	              	<h2><a href="work-single.html">Blue-Macaw</a></h2>
	              </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            <div class="work mb-4 img d-flex align-items-end" style="background-image: url(images/PARROT.jpg);">
            	<a href="images/PARROT.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
	    					<span class="fa fa-expand"></span>
	    				</a>
            	<div class="desc w-100 px-4">
	              <div class="text w-100 mb-3">
	              	<span>Bird</span>
	              	<h2><a href="work-single.html">Parrot</a></h2>
	              </div>
              </div>
            </div>
          </div>
