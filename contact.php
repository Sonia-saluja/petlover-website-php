						...
						<div class="row mb-5">
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Address:</span> North Oak New Diamonds, Sanjauli 171006</p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Email:</span> <a href="mailto:info@petlovers.com">info@petlovers.com</a>
										</p>
									</div>
								</div>
							</div>
							<div class="col-md-3">
								<div class="dbox w-100 text-center">
									...
									<div class="text">
										<p><span>Website</span> <a href="#">petlovers.com</a></p>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="contact-wrap w-100 p-md-5 p-4">
									...
									<form method="POST" action="" id="contactForm" >
										<div class="row">
											...
											<div class="col-md-12">
												<div class="form-group">
													<input type="submit" class="btn btn-primary" name="send-mail">
